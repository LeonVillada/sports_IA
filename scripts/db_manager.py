...
def setup_database():
    ...
    try:
        ...
        cursor.execute("CREATE TABLE IF NOT EXISTS matches (id INT AUTO_INCREMENT PRIMARY KEY, date DATETIME, league_id INT, home_team_id INT, away_team_id INT, home_goals INT DEFAULT NULL, away_goals INT DEFAULT NULL, status VARCHAR(20) DEFAULT 'scheduled', season VARCHAR(10), api_id INT UNIQUE, FOREIGN KEY (league_id) REFERENCES leagues(id), FOREIGN KEY (home_team_id) REFERENCES teams(id), FOREIGN KEY (away_team_id) REFERENCES teams(id))")
